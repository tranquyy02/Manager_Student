...
<body>
    <div class="container">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            ...
            <button type="submit" class="btn btn-primary" style='background-color: #F6702E; border-color: #F6702E; margin-left:440px; margin-bottom: 20px;'>View Attendance</button>
            <a href="index.php" class="btn btn-secondary" style='background-color: #F6702E; border-color: #F6702E;margin-bottom: 20px;'>Back</a>
        </form>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($result_students->num_rows > 0) {
                ...
                echo "<p>There are no students matching your search criteria.</p>";
            }
        }
        ?>
        <footer>
